...
def get_full_taiwan_list():
    ...
    return {"2330.TW": "台積電", "2317.TW": "鴻海"}, "⚠️ 使用內建保底"
...
with st.sidebar:
    st.header("⚙️ 參數設定")
    vol_target = st.slider("1. 量能倍數", 0.1, 3.0, 0.5, 0.1) # 放寬到 0.1
    kd_limit = st.slider("2. KD 門檻", 10, 95, 80, 5) # 放寬到 80
