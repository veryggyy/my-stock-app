...
# --- 1. 頁面與數據讀取設定 ---
st.set_page_config(page_title="2026 台股趨勢回測系統", layout="wide")

@st.cache_data(ttl=86400)
def get_full_taiwan_stock_list():
    """強化版：自動修復 CSV 欄位名稱與多餘符號"""
...
if start_btn:
    ...
    if all_results:
        ...
        st.warning("☹️ 目前未發現符合標的，請嘗試調整靈敏度。")
